...
The sample numbers are slightly off in comparison to the population, but are very close to one another. As the sample size increases, it should become even closer to the mean and standard deviation of the population. The opposite occurs for the decreasing of the sample. By decreasing the sample size, the mean and standard deviation should be further apart from the population's numbers.
