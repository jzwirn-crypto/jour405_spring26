...
The lower the weight, the more frequent the type of person. The higher the weight, the less frequent the type of person in the poll.

3. Why might some respondents be weighted more heavily than others?
Their communities are more or less common in comparison to others who took the poll.
...
Rarely/never has the biggest difference because they are the hardest people to reach.

2. How might these differences affect reporting on likely voter turnout?
Voter turnout is entirely based on the willingness of people to vote. If someone doesn't want to vote, they won't do it and the numbers will be skewed without that group of people. People who don't vote are less likely to even be willing to paerticipate in a poll.
...
These differences exist because certain groups of people are harder to reach, such as those who do not vote in elections. Those who are under-represented are those who don't vote in elections.
