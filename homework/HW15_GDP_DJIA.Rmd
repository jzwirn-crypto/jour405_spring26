...
These two variables are very correlated. This means that the stock market generally trends in the same direction as the economy. If the GDP is up, the DJIA is likely to be up as well. The same goes if the DJIA is up. The GDP will likely be up as well, reflecting the same trend. With a 95% correlation between the two variables, there is a very low chance that they trend in opposite directions from one another.
