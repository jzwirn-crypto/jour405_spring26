...
The distribution is mostly normal, but is slightly skewed to the right. The mean and standard deviations show us that most songs have at least some danceability to them. 

One story idea from this data is to see what songs are considered just about 100% danceable. Based on the data, there is a large number of songs with a danceability score of over 95%. The article would cover what those songs are and describe why they are so perfect for dancing to.
