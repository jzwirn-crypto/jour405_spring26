...
I would call this data to be a skewed right dataframe. It is a little random and all over the place, but it generally goes down as the numbers increase. Most salaries cluster around the $100,000 per year mark.
...
The data is close to following the empirical rule. It's off by a little, but it's close enough that it can be considered to have generally followed the rule. The deviation tells me that the distribution is for sure not normal. However, while it is close, specifically the category of within 2 SD is off by 4%, which is a large difference.
...
The normal approximation tells us what a close estimate of the percentages are, while the actual percentages give us the real numbers for the data. The estimate uses the empirical rule to try and make sense of the data and make it easier to interperet without giving the exact numbers.
...
This tells me that there are less employees making money in the "middle range" than there should be. This means that there are either too many employees earning too much or not enough on their salary.
...
Key differences include the number of employees earning under 60k (thank goodness) and the employees earning over 150k. There are other differences, but those two are the ones that jump out to me the most. This can be explained by the fact that earning under 60K per year is an unlivable salary, so most employees earn more than that. Earning over 150k can be explained by the fact that a lot of more important higher-ups in the government earn more than the average person.
...
Headline: Large portion of White House staff earn between 90k-150k annually.

Lede: According to recent data regarding the salaries of White House employees, 162 of approximately 400 staff earn between 90k-150k per year. This number is lower than expected; with the expected count being over 200 employees. If the White House employees were paid on a normally distributed spread, there should be approximately another 50 employees paid in this salary range. 

Probability thinking: Probability thinking would advance this story by shifting the focus from a single, static number to a dynamic, risk-adjusted, and context-aware narrative. It replaces oversimplified narratives of "hard work equals high pay" with a more accurate picture that includes luck, base rates, and volatility. I could compare this to other government agencies such as members of Congress and analyze if there are any coorelations between the two in terms of how the salary spread looks.
